...
if (daterange.to) {
  ...
  var to = moment().utc();
  log.debug('No end date specified for importing, setting to', to.format());
}
log.debug(to.format());
...
var Market = function () {
  ...
  console.log(this.exchangeSettings.tid);
  ...
  console.log('trade Batcher', this.tradeBatcher);
